package com.mina.npay.gateway.config.filter.security.controller;
...
import com.mina.npay.gateway.config.filter.security.domain.auth.Role;
import com.mina.npay.gateway.config.filter.security.domain.auth.User;
import com.mina.npay.gateway.config.filter.security.domain.auth.UserDetail;
import com.mina.npay.gateway.config.filter.security.service.AuthService;
...
@RestController
@Api(description = "登陆注册及刷新token",hidden = true)
@RequestMapping("/auth")
